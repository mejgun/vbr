...
## 3.3.10  - 2026-05-21 (requires android 7.0, ios 15.6, macos 12.5 with m1 chip)
- Massive build system update
...
## 3.3.2 - 2024-03-04
- Build environment update only

## 3.3.1 - 2024-01-19
### Added
- Internal changes
- UI color change option

## 3.2.1 - 2023-07-05
### Fixed
- Status of records handling
...
### Added
- Compatibility method for older devices
...
### Fixed
- Navigation bar icons alignment

## 3.0.0 - 2022-03-19
- Build environment update

### Added
- UI adapted for large screen devices
- UI improvements
- Remember epg/records position
...
- New icon set for records statuses
...
- EPG search were not showing date for 1st date of month

## 1.7.2 - 2021-07-03
### Added
- Ability to remove external records

## 1.7.1 - 2021-06-26
### Added
- Ability to connect to device secure port
...
## 1.6.3 - 2021-05-29
### Added
- Ability to set zero program count
- Icon for no epg channels when program count is set to 0
- Error description for recordings with error
- Diag info for series recordings
### Fixed
- Build environment update

## 1.6.2 - 2021-05-22
### Fixed
- Rendering issue with recordings tab
...
## 1.5.2 - 2020-09-20
### Added
- Ability to start record immediately
### Fixed
- Small fixes
- Padding for record menu
...
- Recording now icon
### Fixed
- Series records not displaying

## 1.4.0-beta - 2019-07-13
### Added
- Series recordings (if supported)
- 64-bit support
### Fixed
...
## 1.2.8-beta - 2019-05-11
### Added
- Search divided by days
### Fixed
- Bug fixes and other minor improvements

## 1.2.7-beta - 2019-05-10
### Fixed
- Program sorting in program search
### Added
- Show program names in program search

## 1.2.6-beta - 2019-05-10
### Added
- Series records display & cancel

## 1.2.5-beta - 2019-05-08
### Added
